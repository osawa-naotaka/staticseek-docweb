---
title: Basic integration with Nuxt
---
Complete project files for this implementation is published on [Github staticseek repository](https://github.com/osawa-naotaka/staticseek/tree/main/example/nuxt/01.basic).
