---
title: Prepare index at deployment and read index on-demand(Next.js)
---
Complete project files for this implementation is published on [Github staticseek repository](https://github.com/osawa-naotaka/staticseek/tree/main/example/next/02.preindexed).
