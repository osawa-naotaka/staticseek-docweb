---
title: Basic integration with Next.js
---

Complete project files for this implementation are published on the [Github staticseek repository](https://github.com/osawa-naotaka/staticseek/tree/main/example/next/01.basic).
