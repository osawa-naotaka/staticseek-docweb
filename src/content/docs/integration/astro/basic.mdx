...
Complete project files for this implementation is published on [Github staticseek repository](https://github.com/osawa-naotaka/staticseek/tree/main/example/astro/01.basic).
