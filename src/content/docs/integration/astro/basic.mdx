---
title: Basic integration with Astro
---

Complete project files for this implementation are published on the [Github staticseek repository](https://github.com/osawa-naotaka/staticseek/tree/main/example/astro/01.basic).
